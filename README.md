...
## Примітка
Під час виконання проєкту використовувались підходи,
розглянуті на практичному занятті.
Реалізація адаптована під власну структуру коду
та логіку обробки даних.
